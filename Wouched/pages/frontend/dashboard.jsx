          ...
          <>
            ...
            <div className='w-full h-screen pt-20 flex items-center justify-start flex-col'>
              <div className='flex bg-gray-100 flex-wrap items-center justify-center w-full py-2 px-2'>
                ...
                {/* applied Jobs */}
                <div onClick={() => setShowTable('savedJobs')} className='py-2 cursor-pointer border-b-orange-800 border-b-2 px-2 w-60 h-32 rounded mx-2 my-2 bg-white flex items-center justify-center'>
