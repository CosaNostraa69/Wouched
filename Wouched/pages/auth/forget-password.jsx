...
export default function ForgetPassword() {
  ...
  return (
    <>
      <NavBar />
<section className="w-full h-screen bg-[url('/forgetpassword.jpg')] bg-cover bg-center bg-no-repeat">
        ...
        Change Password
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4 lg:mt-5 md:space-y-5" >
              ...
              <div className='text-left'>
                ...
                <input onChange={(e) => setFormData({ ...formData, password: e.target.value })} type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-orange-600 block w-full p-2.5 " required="" />
                {
              ...
              <button type="submit" className="w-full text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Reset password</button>
            </form>
          </div>
        </div>
        <ToastContainer />
